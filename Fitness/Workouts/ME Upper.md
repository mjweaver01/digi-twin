...
> The ME lift is the session. Accessories support it — they don't become a second workout.
...
- **Triceps** — if the ME lift is close-grip bench, board press, pin press, floor press, or JM press, **you already did triceps.** Do not add skull crushers or extensions on top.
- **Horizontal press** — the ME lift is a press. One DB press accessory is plenty; don't stack incline + flat + Arnold.
- **Traps/grip** — carries, shrugs. Pick one.

### ⛔ Do not program
Preacher curls · banded leg curls · Nordic curls · farmer's & suitcase carries · back raises — Mike dislikes these. Bands on the barbell are optional, never mandatory.
