...
echo "  3. Local REST API → copy API key into your AI client's MCP config (see .cursor/mcp.json.example for Cursor)"
echo "  4. Restart MCP in your AI client (Cursor, Claude Code, etc.)"
echo "  5. Copy skills/mike-digital-twin/SKILL.md to your client's skill location — or use a few-shot prompt"
echo "  6. Keep digi-twin open in Obsidian while coding in other repos"
